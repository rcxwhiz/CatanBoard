...
types = ['add', 'brick', 'desert', 'wood', 'ocean', 'ore', 'sheep', 'wheat']
# excluded: blank, mystery, gold
...
class Hex(pygame.sprite.Sprite):
	...
	def increase_value(self):
		if self.type in ['brick', 'wood', 'sheep', 'gold', 'wheat', 'ore']:
